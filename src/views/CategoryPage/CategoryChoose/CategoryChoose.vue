    ...
    <b-row>
      ...
      <b-col cols="12" sm="6" md="6" lg="4">
        <b-form-group label="评分：" label-cols="3">
          <b-form-select :options="scoreOptions" v-model="selected.scoreRange" @change="optionChanged"/>
        </b-form-group>
      </b-col>
      <b-col cols="12" sm="6" md="6" lg="4">
        <b-form-group label="热度：" label-cols="3">
          <b-form-select :options="heatOptions" v-model="selected.heatRange" @change="optionChanged"/>
        </b-form-group>
      </b-col>
      <b-col cols="12" sm="12" md="6" lg="4">
        <b-form-group label="更新时间：" label-cols="4">
          <b-form-select :options="updateTimeOptions" v-model="selected.updateBefore" @change="optionChanged"/>
        </b-form-group>
      </b-col>
      <b-col cols="12" sm="12" md="6" lg="4">
        <b-form-group label="排序依据：" label-cols="4">
          <b-form-select :options="orderOptions" v-model="selected.order" @change="optionChanged"/>
        </b-form-group>
      </b-col>
      <b-col cols="12" sm="12" md="6" lg="4">
        <b-form-group label="排序方式：" label-cols="4">
          <b-form-select :options="orderMethodOptions" v-model="selected.orderMethod" @change="optionChanged"/>
        </b-form-group>
      </b-col>
    </b-row>
    <b-row>
